...
public class HistogramViewCV2_1 extends View {
    ...
    public HistogramViewCV2_1(Context context) {
        this(context, null);
    }

    public HistogramViewCV2_1(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HistogramViewCV2_1(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
